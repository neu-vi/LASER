...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, hidden, xpos=None, use_cache=False, kv_cache=None):
        ...
        for i, blk in enumerate(self.blocks):
            if self.use_checkpoint and self.training:
                ...
                hidden, new_cache = blk(hidden, xpos=xpos, use_cache=True, kv_cache=_cache)
