...
def perform_updates(input_poses, dSloop, ii_loop, jj_loop, iters=30, ep=0.0, lmbda=1e-6, fix_opt_window=False):
    ...
    for itr in range(iters):
        ...
        if cpp_version:
            ...
            delta_pose, = solve_system_py(J_Ginv_i, J_Ginv_j, iii, jjj, resid, ep, lmbda, freen)
